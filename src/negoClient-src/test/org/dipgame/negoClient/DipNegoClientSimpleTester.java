 ...
 */
public class DipNegoClientSimpleTester {

	private static DipNegoClientImpl client;
	...
	private static void createClient(InetAddress ip, int port, String name) {
		DipNegoClientHandler handler = new DipNegoClientHandler() {
			...
			@Override
			public void handleNegotiationMessage(Power from,
		...
		client = new DipNegoClientImpl(ip, port, name, handler);
	}
